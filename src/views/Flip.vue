         ...
         <section class="section-shaped my-0">
             <div class="container shape-container">
                 ...
                 <div class="row mt-3">
                     ...
                     <div class="col-6">
                        <div>
                        <base-button tag="a" type="primary" size="lg" href="#" class="active" @click="applyButtonHorizontal" role="button" :aria-pressed="horizontalPressed">Horizontal</base-button>
                         <base-button tag="a" type="primary" size="lg" href="#" class="active" @click="applyButtonVertikal" role="button" :aria-pressed="vertikalPressed">Vertikal</base-button>
                        </div>
                     ...
                     <div class="col-6 d-flex flex-column flex-end">
                         <base-button tag="a" :href="urlAfter" class="mb-3 mb-sm-0" type="success"
                             icon="ni ni-cloud-download-95" download="rotated-image">
                             Download Hasil
                         </base-button>
                     </div>
                 </div>
...
import type { RefSymbol } from '@vue/reactivity';
 ...
 let applyButtonHorizontal = async () => {
    console.log("ok");
     horizontalPressed.value=!horizontalPressed.value
     await applyImg()
 }

 let applyButtonVertikal = () => {
    vertikalPressed.value=!vertikalPressed.value
}

//  watch(() => horizontalPressed.value, async () => {
//     await applyImg()
//  })
 
//  watch(() => vertikalPressed.value, async () => {
//     await applyImg()
//  })
